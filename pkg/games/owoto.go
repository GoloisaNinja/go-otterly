...
var OneWayOrTheOtter = models.Game{
	...
	Nodes: []models.GameNode{
		...
		{
			ID:                 "56",
			Text:               `Searching your quarters sounds like a good way to miss out on all the action. Let’s face it. Your cheek bones cut sharper than ginsu knives, you’ve got more sauce than a sauce factory, you are more legendary than something that is super legendary. You don’t need credentials or some stupid keycard to solve this problem. No. You just need you, and thankfully, you carry you on your person at all times. Would Ben Afleck need a keycard? Pfff. No freaking way. This ship is as good as saved. You roll your shoulders around, toss your head side to side, and do a little, float like a butterfly, move with your little otter feet. You. Are. Ready. You dash out of the cryo-bay like an otter with a purpose and you are humming “The Final Countdown” as you realize you have absolutely no idea where you are going. Turns out winging it has drawbacks. Blast! Suddenly, an idea emerges from beneath the cryo-sleep memory fog - you don’t NEED to get to the bridge to actually get to the bridge! In case of emergencies, the One Way or the Otter has a remote piloting station located in a separated command module that shouldn’t be too far from your current location! At least, you think it’s not far. The memory is hazy, but you are pretty sure the remote command module is actually near cryonics. As you approach the next deck section, you clearly see a graphic indicating RCM is the next deck over! Huzzah! This is the best plan ever! Keycards are so stupid. You scurry around a few corners and arrive directly in front of the RCM. You try to activate the door panel - but it’s no good. The door just won’t do the whooshie thing! A closer look at the panel reveals why. There’s a text readout. “RCM ONLY ACCESSIBLE TO AUTHORIZED PERSONNEL - AUTHORIZED PERSONNEL INCLUDE CAPTAIN, FIRST OFFICER, AND CHIEF MEDICAL OFFICER. PLEASE INDICATE YOUR LEVEL OF AUTHORIZATION”. That makes sense - you wouldn’t want Joe the Otter from the department of Blinky Lights to be able to pilot the ship remotely. That. Would. Suck. Okay, no big deal. So what level of authorization are you?`,
			CodeNode:           false,
			CodeLength:         0,
			CodeFailedNextNode: 0,
			Options: []models.GameOptions{
				{
					ID:        "56a",
					Text:      `Type "level one" to choose captain auth`,
					Command:   "level one",
					Mood:      "picard",
					HasReqs:   false,
					Inventory: "",
				...
				{
					ID:        "56b",
					Text:      `Type "level two" to choose first officer auth`,
					Command:   "level two",
					Mood:      "riker",
					HasReqs:   false,
					Inventory: "",
				...
				{
					ID:        "56c",
					Text:      `Type "level three" to choose chief medical auth`,
					Command:   "level three",
					Mood:      "pulaski",
					HasReqs:   false,
					Inventory: "",
		...
		{
			ID:                 "57",
			Text:               `Duh. You’re the captain of this bucket, so why would you pick anything other than captain! You slam the panel and indicate that you are, in fact, the freaking captain. The ship suffers another vicious impact or failure of some kind as it lurches to one side and then the other. Whatever you are going to do you need to do it fast! It definitely seems like whatever is happening is getting worse by the second. And the last thing you want is to lose the ship. You are pretty sure you brought your digital collection of every season of the Golden Girls, and to lose that, would be otterly catastrophic. The door terminal makes a few subtle beeping and whirring sounds like it’s processing some chunk of information. A moment later a new text output is displayed. “WELCOME TO RCM CAPTAIN - PLEASE NOTE - 3 FAILED ATTEMPTS OF SECONDARY AUTHORIZATION WILL RESULT IN RCM LOCKOUT. YOUR SECONDARY AUTHORIZATION RIDDLE IS AS FOLLOWS: I AM OFTEN FOUND NEAR A FLOWER. WITHOUT ME, LITTLE IS UNDERSTOOD. YOU HAVE BEEN ME YOUR WHOLE LIFE. REFER TO ME FOR GUIDANCE. WHAT AM I?”.  Only 3 attempts and the RCM gets locked out?? The way the ship is heaving this way and that, you doubt you’ll have time to execute another plan if this one fails! Okay, okay. You got this. You approach the panel and enter your answer…`,
			CodeNode:           true,
			CodeLength:         6,
			CodeFailedNextNode: 59,
			Options: []models.GameOptions{
				{
					ID:        "57a",
					Text:      `Hint: the code must be 6 characters`,
					Command:   "legend",
					Mood:      "legendary",
					HasReqs:   false,
					Inventory: "JL8184AUS",
		...
		{
			ID:                 "58",
			Text:               `The door panel whirs and beeps like nothing you’ve ever heard before and finally a message is displayed on the panel. “INPUT/RESPONSE IS CORRECT! - SECONDARY AUTHORIZATION CONFIRMED. RCM ACCESS CODE JL8184AUS GRANTED.” The RCM door makes a cool whoosh sound and opens to reveal the inner piloting panel! You did it! You immediately start twerking because it seems the only appropriate response to basically saving the world. You are in the middle of really working it when yet another distant explosion rocks the ship and sends you tumbling into the RCM. No big deal, you had probably been celebrating a little too long anyway. But now that you have access to the remote piloting terminal, you can finally get the ship out of whatever predicament your stupid crew got you into. Time to come in like a wrecking ball.`,
			CodeNode:           false,
			CodeLength:         0,
			CodeFailedNextNode: 0,
			Options: []models.GameOptions{
				{
					ID:        "58a",
					Text:      `Type "continue" to begin remote pilot sequence`,
					Command:   "continue",
					Mood:      "",
					HasReqs:   false,
					Inventory: "",
		...
		{
			ID:                 "59",
			Text:               `The panel displays a “PROCESSING INPUT” loading screen and you nervously wait while it seemingly takes forever. Suddenly your ears are assaulted by a terrible ERN ERN sound, like you gave a bad answer on Family Feud or something. The panel flashes a menacing red and displays the text “RIDDLE RESPONSE - INCORRECT - 2 ATTEMPTS REMAINING”. The panel finally returns to its previous state but you now see an indicator that, well indicates, that you have a failed response. Ugh. Why is your ship filled with so much stupid stuff! When you get this hunk of crap back to wherever it is you are going, you are going to make some SEVERE modifications! There’s no time to divert brain cells to all the garbage you’ll be ripping out of the ship, you only have 2 attempts left. You press your little otter paws against your little otter temple in deep thought and move to the panel once again.`,
			CodeNode:           true,
			CodeLength:         6,
			CodeFailedNextNode: 60,
			Options: []models.GameOptions{
				{
					ID:        "59a",
					Text:      `Hint: the code must be 6 characters`,
		...
		{
			ID:                 "60",
			Text:               `The panel displays a “PROCESSING INPUT” loading screen and you nervously wait while it seemingly takes forever. Suddenly your ears are assaulted by a terrible ERN ERN sound, like you gave a bad answer on Family Feud or something. The panel flashes a menacing red and displays the text “RIDDLE RESPONSE - INCORRECT - 1 ATTEMPT REMAINING”. The panel finally returns to its previous state but you now see an indicator that, well indicates, that you have a failed response. Ugh. Why is your ship filled with so much stupid stuff! When you get this hunk of crap back to wherever it is you are going, you are going to make some SEVERE modifications! There’s no time to divert brain cells to all the garbage you’ll be ripping out of the ship, you only have 1 attempt left. You press your little otter paws against your little otter temple in deep thought and move to the panel once again.`,
			CodeNode:           true,
			CodeLength:         6,
			CodeFailedNextNode: 61,
			Options: []models.GameOptions{
				{
					ID:        "60a",
					Text:      `Hint: the code must be 6 characters`,
		...
		{
			ID:                 "61",
			Text:               `The panel displays a “PROCESSING INPUT” loading screen and you nervously wait while it seemingly takes forever. Suddenly your ears are assaulted by a terrible ERN ERN sound, like you gave a bad answer on Family Feud or something. The panel flashes a menacing red and displays the text “RIDDLE RESPONSE - INCORRECT - RCM NOW LOCKED FOR ETERNITY”. What??? Eternity?? Seriously?? Who creates a system that locks you out - FOR ETERNITY?? That’s the stupidest thing you’ve ever heard of!`,
			CodeNode:           false,
			CodeLength:         0,
			CodeFailedNextNode: 0,
			Options: []models.GameOptions{
		...
		{
			ID:                 "62",
			Text:               `You resort to the only thing you can think of. Violence, obviously. You start bashing the absolute crap out of the RCM access terminal while swearing like a depraved person who swears a lot. Your rage reaches a fever pitch as you claw the stupid panel out from the wall, throw it to the floor, and start stomping it like a 1994 broadway production of STOMP. Your rage is exploding out of you like a pants-less Kool-Aid character crashing through an innocent family’s house under the guise of providing hydration. A distant explosion rocks the ship, yet again, but this one is far more powerful and extreme. You can actually hear all the decks around you depressurizing just before your deck also, ultimately, depressurizes and explodes out into space. With your last few breaths in your tiny little otter lungs, you continue to bash the stupid RCM panel. Because if you are going to die, you are damn well making sure this stupid panel dies with you. The last thing you see before your vision goes fully dark, is the RCM panel still flashing a red “LOCKED” message. So either that panel was REALLY well made - or you should probably work out more, because you might actually be a really weak little otter. Game Over.`,
			CodeNode:           false,
			CodeLength:         0,
			CodeFailedNextNode: 0,
			Options: []models.GameOptions{
				...
				{
					ID:          "62b",
					Text:        `Type "after action" to view your after action report`,
					Command:     "after action",
					Mood:        "",
					HasReqs:     false,
					Inventory:   "",
		...
		{
			ID:                 "63",
			Text:               `This is clearly a trick - I mean the only one who should get access to the RCM should be the captain. A non captain officer or chief? Flying the ship? FuggetaboutIt. This is clearly a ruse to fake out some random mop jockey that tries to get cute and break into the RCM. And you wouldn’t put your ACTUAL process in the captain selection because that’s soooo obvi. The ship suffers another vicious impact or failure of some kind as it lurches to one side and then the other. Whatever you are going to do you need to do it fast! It definitely seems like whatever is happening is getting worse by the second. And the last thing you want is to lose the ship. You are pretty sure you brought your digital collection of every season of Supernatural, and to lose that, would be otterly catastrophic. The door terminal makes a few subtle beeping and whirring sounds like it’s processing some chunk of information. A moment later a new text output is displayed. “WELCOME TO RCM FIRST OFFICER - PLEASE NOTE - 3 FAILED ATTEMPTS OF SECONDARY AUTHORIZATION WILL RESULT IN RCM LOCKOUT. YOUR SECONDARY AUTHORIZATION RIDDLE IS AS FOLLOWS: WITHOUT ME - YOU ARE LOST. IT’S WEIRD, BUT YOU ACTUALLY LIKE MY EX. I AM KNOWN FOR MY COORDINATION. WHAT AM I?”.  Only 3 attempts and the RCM gets locked out?? The way the ship is heaving this way and that, you doubt you’ll have time to execute another plan if this one fails! Okay, okay. You got this. You approach the panel and enter your answer…`,
			CodeNode:           true,
			CodeLength:         3,
			CodeFailedNextNode: 74,
			Options: []models.GameOptions{
				{
					ID:        "63a",
					Text:      `Hint: the code must be 3 characters`,
					Command:   "map",
					Mood:      "maps are cool",
					HasReqs:   false,
					Inventory: "JL8184AUS",
		...
		{
			ID:                 "64",
			Text:               `This is clearly a trick - I mean the only one who should get access to the RCM should be the captain. A non captain officer or chief? Flying the ship? FuggetaboutIt. This is clearly a ruse to fake out some random mop jockey that tries to get cute and break into the RCM. And you wouldn’t put your ACTUAL process in the captain selection because that’s soooo obvi. The ship suffers another vicious impact or failure of some kind as it lurches to one side and then the other. Whatever you are going to do you need to do it fast! It definitely seems like whatever is happening is getting worse by the second. And the last thing you want is to lose the ship. You are pretty sure you brought your digital collection of every season of Midsomer Murders, and to lose that, would be otterly catastrophic. The door terminal makes a few subtle beeping and whirring sounds like it’s processing some chunk of information. A moment later a new text output is displayed. “WELCOME TO RCM CHIEF MEDICAL OFFICER - PLEASE NOTE - 3 FAILED ATTEMPTS OF SECONDARY AUTHORIZATION WILL RESULT IN RCM LOCKOUT. YOUR SECONDARY AUTHORIZATION RIDDLE IS AS FOLLOWS: MY FAVOURITE PART OF AN ARTICLE IS THE HEADING. I FAVOUR GIFTS FROM THE ORIENT. UNFORTUNATELY, I AM EASILY FOOLED. WHAT AM I?”.  Only 3 attempts and the RCM gets locked out?? The way the ship is heaving this way and that, you doubt you’ll have time to execute another plan if this one fails! Okay, okay. You got this. You approach the panel and enter your answer…`,
			CodeNode:           true,
			CodeLength:         7,
			CodeFailedNextNode: 76,
			Options: []models.GameOptions{
				{
					ID:        "64a",
					Text:      `Hint: the code must be 7 characters`,
					Command:   "compass",
					Mood:      "needle in a space stack",
					HasReqs:   false,
					Inventory: "JL8184AUS",
					NextNode:  "58",
					PlayType:  "intelligent",
		...
		{
			ID:                 "65",
			Text:               `The excitement you felt just a moment ago as your little otter booty was shaking like no one was watching, quickly fades as you lay your eyes on the remote pilot terminal. It looks like something out of a bad episode of Firefly, which is impossible, because there are no bad episodes of Firefly. But the point is, the remote pilot terminal looks hella confusing. Levers? Check. Blinking lights? Oh yes. Switches galore? Yup. You were kinda hoping for a “PRESS THIS - SAVE DAY” button. But a cursory glance over the terminal reveals no such button. Ugh. Lame. The ship heaves to one side violently, yet again, and you are really getting tired of this flopping around non-sense. There are monitors, flight sticks, buttons, and various lockers on this monstrosity of a remote module. You DO NOT have time to do everything. You’ll get maybe two actions, at best, before the ship succumbs to whatever is plaguing it. What do you want to do?`,
			CodeNode:           false,
			CodeLength:         0,
			CodeFailedNextNode: 0,
			Options: []models.GameOptions{
				{
					ID:        "65a",
					Text:      `Type "flight stick" to maneuver`,
					Command:   "flight stick",
					Mood:      "last starfighter",
					HasReqs:   false,
					Inventory: "",
					NextNode:  "66",
					PlayType:  "aggressive",
				...
				{
					ID:        "65b",
					Text:      `Type "nav panel" for course control`,
					Command:   "nav panel",
					Mood:      "the cartographer",
					HasReqs:   false,
					Inventory: "",
					NextNode:  "67",
					PlayType:  "intelligent",
				...
				{
					ID:        "65c",
					Text:      `Type "thrusters" for booster control`,
					Command:   "thrusters",
					Mood:      "blaster master",
					HasReqs:   false,
					Inventory: "",
		...
		{
			ID:                 "66",
			Text:               `Joysticks are the absolute best and this heavily influences your decision to just go right for the flight stick. You are a captain, but you’re guessing you were probably a bad ass pilot before becoming an even more bad ass captain. Because that’s just how most of those story arcs go! As such, you’ve probably got mad Last Startfighter kind of skills. You grab the flight stick and look at the monitor in front of you. The monitor shows a massive debris field - could be the ship strayed into a ring cluster, because your crew is the worst. You start to nimbly pilot the ship through the debris field. It’s literally just like old times when you used to bullseye womp rats in your T-16 in Beggar’s Canyon back home. All the sudden there’s a light that starts off as a warning light - yellow, that quickly changes to a full on bright red that starts going off. The monitor indicates a positioning problem! Oh craaaap! It could be a course warning or maybe the speed is off? What do you want to do?`,
			CodeNode:           false,
			CodeLength:         0,
			CodeFailedNextNode: 0,
			Options: []models.GameOptions{
		...
		{
			ID:                 "67",
			Text:               `This isn’t going to be as easy as when you used to bullseye womp rats in Beggar’s Canyon in your T-16 back home. The One Way or the Otter is massive. Oh yeah, and it’s filled with explosive hydro-carbons! The best thing will be to check available course options via the nav panel. With at least a general course you should be able to take next steps from there to get the One Way or the Otter out of trouble. You scoot over to the nav panel and fire it up. The display bursts to life and shows a massive debris field, literally thousands of objects the size of small ships clouding the screen. It’s a total mess. You quickly engage the computer to plot the least dangerous general course through the field. With that set now you have to decide what to do next!`,
			CodeNode:           false,
			CodeLength:         0,
			CodeFailedNextNode: 0,
			Options: []models.GameOptions{
		...
		{
			ID:                 "68",
			Text:               `You’ve watched enough sci-fi to know that speed is always the problem. Got caught by imperial scum? Problem: Speed. Ship damaged from being caught inside another ship that is now exploding from the inside out? Problem: Speed. Missed out on the last of the Fizzy Drinks at the canteen during 1st shift dinner? Problem: Freaking. Always. Speed. You scoot over to the thruster master omni-engine control and jam the lever to full. You are not going to let speed slow you down this time! Wait? What? Nevermind. The important thing is, you are the captain and you are warping this hunk of crap out of trouble because that’s what awesome captains do! You feel an impossibly strong jolt as the ship accelerates to ludicrous speed. You scoot over to the flight controls and power up the outward monitor. As the screen blazes to life you are confronted with a terrible sight. The monitor shows a scene literally FILLED with debris. The debris field is massive and densely packed as well, and thanks to your thruster override, you are now traveling straight at it! You try to roll the ship and go inverted because it’s both bad ass, and a viable evasive maneuver, but it’s too late. The One Way or the Otter slams viciously into a piece of debris the size of a small moon. As the ship starts breaking up around you, you can’t help but feel like your crew really let you down. I mean why didn’t anyone tell you that there was so much space junk around? As your vision fades to black, the last thing you ever contemplate is pay cuts for your crappy crew. Game Over.`,
			CodeNode:           false,
			CodeLength:         0,
			CodeFailedNextNode: 0,
			Options: []models.GameOptions{
		...
		{
			ID:                 "69",
			Text:               `You scoot away from where you were at, but before you can even begin to engage in the next remote sequence there is a horrendous screaming of metal followed by a cacophony of crashes, bangs, and percussive explosions. Oh this is bad. This is sooooo bad! Why is your crew so awful! You were just trying to get a nap in cryo and now look at what they’ve done! There’s no mistaking the sound of all the decks around you decompressing and being shorn off into space. Whatever you were going to do - it’s too late now. The ship has obviously been hit by a large enough object to break the One Way or the Otter completely apart. I mean, what an awful shame. How are you going to win captain of the year if you’re dead? Do they award captain of the year posthumously? You are trying to formulate a real zinger for the opening line of your acceptance speech as you, and everything around you, get ejected into the blackness of space. It was probably going to be a fart joke. Game Over.`,
			CodeNode:           false,
			CodeLength:         0,
			CodeFailedNextNode: 0,
			Options: []models.GameOptions{
		...
		{
			ID:                 "70",
			Text:               `With the course dialed in, it makes the most sense to first orient the ship, and then engage the omni-engine boosters! That sequence should give you the best chance of being able to navigate this horrific debris field. You scoot to the flight stick and bring the ship around to the correct heading using auxiliary flight control thrusters. I mean, look at you, that was some real Last Starfighter crap right there! You are in the middle of a JAY-Z brushing your shoulder off move when the proximity alarm starts blaring! There is literally a chunk of debris that looks almost half the size of the One Way or the Otter coming. Right. At. You. You obviously finish the brush your shoulder off move, because you can’t just interrupt a brush the shoulder off move, but then you scoot over to the thruster master omni-engine controls. You dramatically look at the monitor and in your most serious otter voice say “Sorry Space Debris - your face is writing checks my body can’t caaaash”. You put a pair of “deal with it” glasses on - you aren’t even sure where you got them. But, you put them on, and mash the omni-engine thruster to max. The only problem is. Absolutely nothing happens. You repeat your epic line and mash the thrust to max again. Still. Nothing. Ugggh. This day suuuuucks! Catch phrase moment - TOTAL RUINED! You rip off the “deal with it” glasses and let your eyes dart around the various monitors. And that’s when you spot it. There’s a small monitor with a keypad in front of it. The monitor reads “ENTER RCM ACCESS CODE TO CONFIRM AND EXECUTE THRUSTER BURN”. OMG the freaking code from when you opened the door?! The large piece of space debris is impossibly close now! You’ve only got time for one try!`,
			CodeNode:           true,
			CodeLength:         9,
			CodeFailedNextNode: 72,
			Options: []models.GameOptions{
				{
					ID:        "70a",
					Text:      `ENTER RCM CODE - (9 CHARS)`,
					Command:   "jl8184aus",
					Mood:      "DEAL WITH IT",
					HasReqs:   false,
					Inventory: "",
		...
		{
			ID:                 "71",
			Text:               `The monitor glows a glorious green as your code is accepted. You feel an enormous amount of force as the thrusters engage and rocket the ship on a course out of the debris field. You make a few minor course corrections with the flight controls to fully exit the field, and set a course literally anywhere but here.  You sit back in your chair and put your “deal with it” glasses back on. This giant bucket of bolts is going to need an absolute ton of repairs, and who knows how many of your crew were injured or even killed. But you’ll have to sort all that out later. For now, you are going to sit here, in this tiny Remote Command Module, and take the nap that was robbed from you so egregiously. As you put your little feet up on the main console, you can’t help but think what a great captain you are. You saved this whole freaking ship and you didn’t even need to do it from the bridge. The captain of the year award is a total lock you think. As you imagine yourself hoisting the trophy in front of a crowd of otter loser captains, you drift off into a pleasant and peaceful sleep, dreaming of your absolutely lit acceptance speech where you will mercilessly drag, and throw shade, at all those miserable haters. It’s good to be the best there ever was. *COMMAND ARC - CAPTAIN OF THE YEAR ENDING ACHIEVED - CONGRATULATIONS - GAME OVER*`,
			CodeNode:           false,
			CodeLength:         0,
			CodeFailedNextNode: 0,
			Options: []models.GameOptions{
		...
		{
			ID:                 "72",
			Text:               `You furiously type in the code and bash the enter key! There’s no time for the access code craaaap! The panel suddenly starts buzzing loudly and you eyes light up with the furious red being emitted by the access entry panel. You entered the code! Do you enter it wrong? Oh my freaking god - did you fat finger it?? DID YOU FAT FINGER THE ACCESS CODE??!! You quickly try to navigate the panel prompts that will take you back to the code entry screen!`,
			CodeNode:           false,
			CodeLength:         0,
			CodeFailedNextNode: 0,
			Options: []models.GameOptions{
				{
					ID:        "72a",
					Text:      `Type "continue" to reauthenticate!`,
					Command:   "continue",
					Mood:      "of all the ways to die",
					HasReqs:   false,
					Inventory: "",
					NextNode:  "73",
					PlayType:  "reckless",
		...
		{
			ID:                 "73",
			Text:               `You are trying to get back to the prompt where you can re-enter the code, but it’s already too late. You hear the screeching and screaming of metal support braces and beams as they buckle, crush, and give way. The One Way or the Otter has been hit by a giant piece of debris and has sustained a catastrophic hull breach. Your first thought is. Who can you pin this on? Whose fault is this? Who can you absolutely throw under the bus for this one? As your adorable, tiny, little otter body is evacuated, unprotected, into the black, cold, darkness of space. It hits you. The otter that stole your uniform! This is, literally, all that otter’s fault. You decide to name him Dave, for no reason, really. But you hate Dave. Dave has murdered the entire crew of the One Way or the Otter, and has single handedly destroyed what might be the greatest digital collection of off-beat 90’s sitcoms ever. You had a data pad with pure gold on it. Just Shoot Me. Boy Meets World. Newsradio. And Wings. My god. Wings. And now? It’s all gone. Because Dave. With your last frozen breath, you curse Dave and all his progeny. Game Over.`,
			CodeNode:           false,
			CodeLength:         0,
			CodeFailedNextNode: 0,
			Options: []models.GameOptions{
